...
class ItemRequestsControllerTest < ActionController::TestCase
  ...
  test "should create item_request" do
    assert_difference('ItemRequest.count') do
      post :create, item_request: { date_request: @item_request.date_request, estimated_return_date: @item_request.estimated_return_date, item_id: @item_request.item_id, user_id: @item_request.user_id }
    end
  ...
  test "should update item_request" do
    patch :update, id: @item_request, item_request: { date_request: @item_request.date_request, estimated_return_date: @item_request.estimated_return_date, item_id: @item_request.item_id, user_id: @item_request.user_id }
    assert_redirected_to item_request_path(assigns(:item_request))
  end
